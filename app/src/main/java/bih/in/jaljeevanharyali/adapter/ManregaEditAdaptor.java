...
public class ManregaEditAdaptor extends BaseAdapter {
    ...
    public ManregaEditAdaptor(ManregaListActivity listViewshowedit, ArrayList<ManregaSchemeDetail> rlist, UserDetails userInfo) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ManregaEditAdaptor.ViewHolder holder = null;
        //if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adaptor_marega_list, null);

            holder = new ManregaEditAdaptor.ViewHolder();
                    ...
                    new AlertDialog.Builder(activity)
                            ...
                            .setPositiveButton("हाँ", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    long c = dataBaseHelper.deleteManregadData(inspectionid, type);
...
//
            ...
            holder.tv_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i=new Intent(activity, ManregaInspectionActivity.class);
                            ...
                            .setPositiveButton("हाँ", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    if (Utiilties.isOnline(activity)) {
                                        ...
                                        new ManregaEditAdaptor.UploadManregaDetail(ThrList.get(position), position, type).execute();
                                    }
                                    else {
...
//        }
//        else {
//            holder = (ManregaEditAdaptor.ViewHolder) convertView.getTag();
//        }
        return convertView;
    }
    ...
    private class UploadManregaDetail extends AsyncTask<String, Void, String> {
...
//        UserDetails userInfo = dataBaseHelper.getUserDetails(username, password);
        ...
        UploadManregaDetail(ManregaSchemeDetail data, int position, int type) {
            this.data = data;
        ...
        protected String doInBackground(String... param) {
            ...
            Log.e("PID", ""+data.getId());
            String res = WebServiceHelper.uploadManregadata(this.data, type);
            return res;
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                if (result.equalsIgnoreCase("1")) {
                    ...
                    long isDel = localDBHelper.resetManregadData(String.valueOf(this.data.getId()), type);
                    if (isDel > 0) {
