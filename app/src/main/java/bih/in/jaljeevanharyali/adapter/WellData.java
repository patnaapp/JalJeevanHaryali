...
public class WellData extends ArrayList<WellData> implements Serializable {
    ...
    public WellData(SoapObject final_object) {
    ...
    public WellData(SoapObject final_object, String s) {
