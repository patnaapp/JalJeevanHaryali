...
public class WellReportAdapter extends BaseAdapter {
    ...
    public WellReportAdapter(WellReportActivity listViewshowedit, ArrayList<PondWellReportEntity> rlist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        WellReportAdapter.ViewHolder holder = null;
        //if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adaptor_well, null);

            holder = new WellReportAdapter.ViewHolder();
