...
public class GPSTracker extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            permission=new MarshmallowPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION);
            ...
            permission=new MarshmallowPermission(mContext, Manifest.permission.ACCESS_COARSE_LOCATION);
            if(permission.result==-1 || permission.result==0) {
