...
public class MapWellActivity extends Activity implements GoogleMap.OnMarkerClickListener, GoogleMap.OnMyLocationChangeListener, GoogleMap.OnInfoWindowClickListener,GoogleMap.OnMapClickListener,GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener{
    GoogleMap map;
    GPSTracker gps;
    LatLng latlon;
   ...
   String pachId="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(MapWellActivity.this);
        localDBHelper=new DataBaseHelper(MapWellActivity.this);
              ...
              /*  Intent i = new Intent(getBaseContext(), WebViewActivity.class);
                ...
                ab.setNegativeButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        // dialog.dismiss();
                        //finish();
                        if(Utiilties.isOnline(MapWellActivity.this)) {
        ...
        if (isOnline(MapWellActivity.this) == false) {
            showAlet(MapWellActivity.this);
        } else {
            getgps();
        }
...
//        map_list.setAdapter(new dataListAdapter());
        ...
        if (latlon != null) {
            ...
            if (i == 1) {
                ...
                if(ret_booths.size()==0) {
                    ...
                    Toast.makeText(MapWellActivity.this,"Located "+ret_booths.size()+" Well",Toast.LENGTH_LONG).show();
               ...
               /* AsyncPostData task = new AsyncPostData(new LatLng(gps.getLatitude(), gps.getLongitude()));
                ...
                //ret_booths=findNearByPlaces(latitude, longitude);
                    ...
                    //ret_booths = localDBHelper.getWellsInspectionDetail(pachId);
   ...
   /* private boolean isInRange(double currentLat, double currentlongi,double databaseLat, double databaselongi)
    ...
    public void getgps() {
        // create class object
        gps = new GPSTracker(MapWellActivity.this);
        double latitude = 0.0;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_settings:
                ...
                AlertDialog.Builder LicenseDialog = new AlertDialog.Builder(MapWellActivity.this);
...
//                    }
    ...
    private void callTheNumber(String number) {
        ...
        {
            Toast.makeText(MapWellActivity.this, "Calling Features are not Supported on Your Device", Toast.LENGTH_LONG).show();
        }
    }
