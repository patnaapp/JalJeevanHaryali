...
public class OtherDeptInspectionActivity extends Activity {
    ...
    LinearLayout ll_phase1,ll_phase2,ll_phase3,ll_entry_phase1,ll_entry_phase2,ll_entry_phase3,ll_electricity,ll_land_detail,ll_tree_count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_dept_inspection);
        ...
        btn_phase1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validateData()) {
                    ...
                    Toast.makeText(OtherDeptInspectionActivity.this, "Please filled all required field", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void Initialization() {
        ...
        ll_tree_type = (LinearLayout) findViewById(R.id.ll_tree_type);
        ll_electricity = (LinearLayout) findViewById(R.id.ll_electricity);
        ll_land_detail = (LinearLayout) findViewById(R.id.ll_land_detail);
        ll_tree_count = (LinearLayout) findViewById(R.id.ll_tree_count);

        spin_tree_type = (Spinner) findViewById(R.id.spin_tree_type);

        ll_required_field = (LinearLayout) findViewById(R.id.ll_required_field);
        ...
        et_rakba =(EditText)findViewById(R.id.et_rakba);
        et_owner_name =(EditText)findViewById(R.id.et_owner_name);
        et_mobile =(EditText)findViewById(R.id.et_mobile);
        et_consumer_no =(EditText)findViewById(R.id.et_consumer_no);
        et_consumer_bill =(EditText)findViewById(R.id.et_consumer_bill);
        et_total_tree =(EditText)findViewById(R.id.et_total_tree);
        et_live_tree =(EditText)findViewById(R.id.et_live_tree);
    ...
    public void extractDataFromIntent(){
        ...
        Log.e("InspId", ""+id);
        info = dataBaseHelper.getOtherSchemeDetail(String.valueOf(id));
    ...
    public void setData(ManregaSchemeDetail info){
        ...
        tv_village.setText(info.getVillage_Name());
        ...
        if(info.getIsUpdated() != null && info.getIsUpdated().equals("1")){
            if(info.getYojnaType() != null && info.getYojnaType().equals("U")){
                ...
                tv_title_phase3.setText("कार्य के उद्घाटन के दौरान");
...
//                }
    ...
    public void moveToCamera(int type){
        Intent intent = new Intent(this, OtherSchemePhotoActivity.class);
    ...
    public void moveToLocation(int type){
        ...
        intent.putExtra("isOpen", s1_data);
        intent.putExtra("remark", remark);
        intent.putExtra("inspType", "other");
        startActivity(intent);
        finish();
    }
}
