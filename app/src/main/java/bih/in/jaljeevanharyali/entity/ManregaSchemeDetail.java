...
public class ManregaSchemeDetail implements KvmSerializable {

    public static Class<ManregaSchemeDetail> ManregaSchemeDetail_CLASS = ManregaSchemeDetail.class;
    ...
    public ManregaSchemeDetail(SoapObject res1) {
...
//        this.Ward_Id=res1.getProperty("WARDCODE").toString();
//        this.Ward_Name=res1.getProperty("WARDNAME").toString();
        ...
        this.Scheme_Code=res1.getProperty("MIS_Scheme_Code").toString();
...
//        this.LandOwnerName=res1.getProperty("LandOwnerName").toString();
    ...
    public ManregaSchemeDetail() {
    }

    public static Class<ManregaSchemeDetail> getManregaSchemeDetail_CLASS() {
        return ManregaSchemeDetail_CLASS;
    }

    public static void setManregaSchemeDetail_CLASS(Class<ManregaSchemeDetail> manregaSchemeDetail_CLASS) {
        ManregaSchemeDetail_CLASS = manregaSchemeDetail_CLASS;
    }
